...
public class Exp2 {
    public static void main(String[] args) {
        Player p = new Cricket_Player("Rohit", 30, 190, "Team1", "Batsman");
        p.printDetails();
        p = new Football_Player("Lionel", 25, 200.5, "Team2", "Extras");
        p.printDetails();
        p = new Hockey_Player("Amarjeet", 40, 170, "Team3", "Bowler");
    }
}
